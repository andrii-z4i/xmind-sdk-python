...
class MarkerRefsElementTest(base.Base):
    ...
    def test_init_without_parameters(self):
        """test that object of the class could be created without parameters and it has correct static attribute"""
        with patch('xmind.core.mixin.WorkbookMixinElement.__init__') as WorkbookMixinElementMock:
            ...
            with self.assertRaises(Exception):
                MarkerRefsElement('test', 2, 3)
                WorkbookMixinElementMock.assert_called_with('test', 2, 3)
