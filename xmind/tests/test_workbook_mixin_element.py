...
class WorkbookMixinElementTest(base.Base):
    ...
    LOGGER = logging.getLogger('WorkbookMixinElementTest')
    ...
    def test_init_with_parameters(self):
        ...
        self._registOwnerWorkbook_method = self._init_patch_with_name('_registOwnerWorkbook', 'xmind.core.mixin.WorkbookMixinElement.registOwnerWorkbook')
    ...
    def test_excessive_parameters(self):
        _get_attribute = self._init_patch_with_name('_get_attribute', 'xmind.core.Element.getOwnerDocument')
        _set_attribute = self._init_patch_with_name('_set_attribute', 'xmind.core.Element.setOwnerDocument')
        _getAttribute_method = self._init_patch_with_name('_getAttribute', 'xmind.core.Element.getAttribute')
        _readable_time_method = self._init_patch_with_name('_readable_time', 'xmind.utils.readable_time')
        _get_current_time_method = self._init_patch_with_name('_get_current_time', 'xmind.utils.get_current_time')
        _setAttribute__method = self._init_patch_with_name('_setAttribute', 'xmind.core.Element.setAttribute')
    ...
    def test_regist_owner_workbook(self):
        ...
        self._setOwnerDocument_method = self._init_patch_with_name('_setOwnerDocument', 'xmind.core.Element.setOwnerDocument')
    ...
    def test_get_modified_time_with_none_timestamp(self):
        ...
        self._registOwnerWorkbook_method = self._init_patch_with_name('_registOwnerWorkbook', 'xmind.core.mixin.WorkbookMixinElement.registOwnerWorkbook')
        self._getAttribute_method = self._init_patch_with_name('_getAttribute', 'xmind.core.Element.getAttribute', return_value=None)
        obj = WorkbookMixinElement("test", self._ownerWorkbook)
    ...
    def test_get_modified_time(self):
        ...
        self._registOwnerWorkbook_method = self._init_patch_with_name('_registOwnerWorkbook', 'xmind.core.mixin.WorkbookMixinElement.registOwnerWorkbook')
        self._getAttribute_method = self._init_patch_with_name('_getAttribute', 'xmind.core.Element.getAttribute', return_value=1)
        self._readable_time_method = self._init_patch_with_name('_readable_time', 'xmind.utils.readable_time', return_value="time")
        obj = WorkbookMixinElement("test", self._ownerWorkbook)
    ...
    def test_set_modified_time(self):
        ...
        self._registOwnerWorkbook_method = self._init_patch_with_name('_registOwnerWorkbook', 'xmind.core.mixin.WorkbookMixinElement.registOwnerWorkbook')
        self._setAttribute__method = self._init_patch_with_name('_setAttribute', 'xmind.core.Element.setAttribute')
        obj = WorkbookMixinElement("test", self._ownerWorkbook)
    ...
    def test_set_modified_time_throws(self):
        ...
        self._registOwnerWorkbook_method = self._init_patch_with_name('_registOwnerWorkbook', 'xmind.core.mixin.WorkbookMixinElement.registOwnerWorkbook')
        self._setAttribute__method = self._init_patch_with_name('_setAttribute', 'xmind.core.Element.setAttribute', Exception("ValueError"))
        obj = WorkbookMixinElement("test", self._ownerWorkbook)
    ...
    def test_update_modified_time(self):
        ...
        self._registOwnerWorkbook_method = self._init_patch_with_name('_registOwnerWorkbook', 'xmind.core.mixin.WorkbookMixinElement.registOwnerWorkbook')
        self._get_current_time_method = self._init_patch_with_name('_get_current_time', 'xmind.utils.get_current_time', return_value=12345)
        self._setAttribute__method = self._init_patch_with_name('_setAttribute', 'xmind.core.Element.setAttribute')
    ...
    def test_get_ID(self):
        """Test getID method"""
        self._registOwnerWorkbook_method = self._init_patch_with_name('_registOwnerWorkbook', 'xmind.core.mixin.WorkbookMixinElement.registOwnerWorkbook')
        self._getAttribute__method = self._init_patch_with_name('_getAttribute', 'xmind.core.Element.getAttribute', return_value="value")
